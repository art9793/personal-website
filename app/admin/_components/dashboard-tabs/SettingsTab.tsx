...
export function SettingsTab() {
  ...
  return (
    <div className="max-w-4xl space-y-4 md:space-y-12 pb-24 md:pb-0">
      <div className="hidden md:block pb-6 border-b border-border">
        <h2 className="text-xl md:text-2xl font-medium tracking-tight">Home Page Settings</h2>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-lg md:text-xl font-medium mb-1.5">Profile Picture</h3>
          <p className="text-xs md:text-sm text-muted-foreground">This image appears on your homepage</p>
        </div>
        <div className="p-6 md:p-8 lg:p-10 bg-background border border-border rounded-xl">
          <div className="flex flex-col md:flex-row md:items-start gap-6 md:gap-8">
            <div className="flex-shrink-0">
              <Avatar className="h-24 w-24 md:h-28 md:w-28 ring-2 ring-border/20 ring-offset-2 ring-offset-background">
                ...
                <AvatarFallback className="text-xl md:text-2xl bg-muted font-medium">{formData?.name?.substring(0, 2).toUpperCase() || 'AT'}</AvatarFallback>
              </Avatar>
            </div>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-lg md:text-xl font-medium mb-1.5">Profile Information</h3>
          <p className="text-xs md:text-sm text-muted-foreground">Your name, title, and bio</p>
        </div>
        <div className="space-y-6 p-6 md:p-8 lg:p-10 bg-background border border-border rounded-xl">
          <div className="space-y-3">
            ...
            <Input
              ...
              className="h-11 text-base transition-all border border-border bg-background hover:border-border focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:border-primary"
          ...
          <div className="space-y-3">
            ...
            <Textarea
              ...
              className="min-h-[140px] text-base transition-all border border-border bg-background hover:border-border focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:border-primary resize-none leading-relaxed"
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-lg md:text-xl font-medium mb-1.5">Social Links</h3>
          <p className="text-xs md:text-sm text-muted-foreground">Connect your social profiles</p>
        </div>
        <div className="space-y-4">
          {/* Twitter */}
          <div className="group bg-background border border-border rounded-lg transition-all duration-200 overflow-hidden">
